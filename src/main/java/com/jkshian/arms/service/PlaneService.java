...
public class PlaneService {
    private static PlaneRepo planeRepo;
    ...
    public static ResponseEntity<String> updatePlane(Planedto planedto) {
    ...
    public static Planedto getPlaneById(int id) {
    ...
    public static List<Planedto> getAllPlane() {
